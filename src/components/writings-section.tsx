...
export function WritingsSection() {
  ...
  return (
    <div className="space-y-12">
      {/* Header */}
      <section id="writings-intro" className="space-y-6">
        <div className="text-center space-y-4">
          <h1 className="text-4xl lg:text-5xl font-bold">My Writings</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Thoughts, tutorials, and insights about web development, technology trends, and software engineering
          </p>
        </div>
      </section>

      {/* Featured Articles */}
      <section id="featured-articles" className="space-y-8">
      ...
      {/* Recent Articles */}
      <section id="recent-articles" className="space-y-8">
      ...
      {/* Topics */}
      <section id="topics" className="space-y-8">
        <h2 className="text-3xl font-bold">Topics I Write About</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Frontend Development</CardTitle>
              <CardDescription>React, Next.js, TypeScript, and modern frontend architectures</CardDescription>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Backend & APIs</CardTitle>
              <CardDescription>Node.js, databases, API design, and server-side development</CardDescription>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Developer Experience</CardTitle>
              <CardDescription>Tools, workflows, best practices, and productivity tips</CardDescription>
            </CardHeader>
          </Card>
        </div>
      </section>
