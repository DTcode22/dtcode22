import type { SpiralPatternParams, RenderPatternFn } from './types';

export const spiralDefaultParams: SpiralPatternParams = {
  speed: 0.5,
  scale: 1,
  intensity: 1,
  distortion: 5,
...
export const renderSpiral: RenderPatternFn = (ctx, canvas, params, time) => {
